...
Public Class XRSPK
    ...
    Public Sub InitializeData(ByVal Bind As Collection)
        cmsl = New SqlDataAdapter("Select D.Urut,D.Nama as Divisi, BD.KompID, K.Nama As Komponen, BD.BBID, B.Nama As Bahan, BD.UkBB, BD.Sat, Round(Std,2) as Std,Keb,BD.Uk,BD.Ket,stsAdd,BBIDInd,D.Gol From T_BOMDtl BD Inner Join M_Div D On BD.DivID=D.DivID Inner Join M_Komp K On BD.KompID=K.KompID Inner Join M_BB B On BD.BBID=B.BBID Where BD.BOMID='" & Bind.Item("Kode").ToString & "' and ArtCode In (Select ArtCode From T_BOMPO where BOMID='" & Bind.Item("Kode").ToString & "') and SPK='True' and D.Gol like '" & Bind.Item("divisi").ToString & "' Order By D.Urut,K.Urut,K.Nama,B.Nama,BD.Uk,BBIDInd Asc", koneksi)
    ...
    Private Sub ReportFooter_BeforePrint(sender As Object, e As Printing.PrintEventArgs) Handles ReportFooter.BeforePrint
        If ReportFooter.Visible = True Then
            Me.XrLabel28.Visible = True
            Me.LBKet.Visible = True
            Me.XrLabel17.Visible = True
            Me.XrLabel39.Visible = True
            Me.LBWarnaF.Visible = True
            Me.LBAss1.Visible = True
            Me.LBUkF1.Visible = True
            Me.LBUkF2.Visible = True
            Me.LBAss2.Visible = True
            Me.LBUkF3.Visible = True
            Me.LBAss3.Visible = True
            Me.LBUkF4.Visible = True
            Me.LBAss4.Visible = True
            Me.LBUkF5.Visible = True
            Me.LBAss5.Visible = True
            Me.LBUkF6.Visible = True
            Me.LBAss6.Visible = True
            Me.LBUkF7.Visible = True
            Me.LBAss7.Visible = True
            Me.LBUkF8.Visible = True
            Me.LBAss8.Visible = True
            Me.XrLabel14.Visible = True
            Me.LBSampSize.Visible = True
        Else
            Me.XrLabel28.Visible = False
            Me.LBKet.Visible = False
            Me.XrLabel17.Visible = False
            Me.XrLabel39.Visible = False
            Me.LBWarnaF.Visible = False
            Me.LBAss1.Visible = False
            Me.LBUkF1.Visible = False
            Me.LBUkF2.Visible = False
            Me.LBAss2.Visible = False
            Me.LBUkF3.Visible = False
            Me.LBAss3.Visible = False
            Me.LBUkF4.Visible = False
            Me.LBAss4.Visible = False
            Me.LBUkF5.Visible = False
            Me.LBAss5.Visible = False
            Me.LBUkF6.Visible = False
            Me.LBAss6.Visible = False
            Me.LBUkF7.Visible = False
            Me.LBAss7.Visible = False
            Me.LBUkF8.Visible = False
            Me.LBAss8.Visible = False
            Me.XrLabel14.Visible = False
            Me.LBSampSize.Visible = False
        End If
    End Sub
End Class