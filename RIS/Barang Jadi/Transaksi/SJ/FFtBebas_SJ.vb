...
Public Class FFtBebas_SJ
    ...
    Public Sub FillDtl(Kode As String)
        Dim cmsl As SqlDataAdapter
        cmsl = New SqlDataAdapter("Select JualIDD,JualID,Nama,Qty,Size,Sat,HarSat,HarSbDisc,DiscRp,DiscP,RpDiscP,HarAkhir From T_JualBebas_SJDtl Where JualID='" & Kode & "'", koneksi)
    ...
    Public Sub FillDt()
        Dim cmsl As SqlDataAdapter
        cmsl = New SqlDataAdapter("Select JualID,PeriodID,Tanggal,Jenis,NoPajak,'' as CustID,H.CustID as Nama,H.Alamat,H.Kota,CurrID,MtUang,NilTukarRp, Kat, TipePPn, PersenPPn, NoPajak, PEB, TglPEB, BL, TglBL, LC, TotSbDisc, DiscP, RpDiscP, DiscRp, TotDisc,TotDPP, TotPPn, TotQty, TotAkhir, TotAkhirRp, SisaBayar, H.Ket, stsPPn, stsLunas, H.InsDate, H.InsBy, H.UpdDate, H.UpdBy From T_JualBebas_SJ H  Where PeriodID=" & MainModule.periodAktif & " Order By Tanggal,JualID asc", koneksi)
    ...
    Public Sub Del()
        ...
        Dim cmSP As New SqlCommand("SPDelT_JualBebas_SJ")
    ...
    Private Sub BVBEdit_ItemClick(sender As Object, e As DevExpress.XtraBars.Ribbon.BackstageViewItemEventArgs) Handles BVBEdit.ItemClick
        ...
        If Me.GridView2.GetFocusedDataRow.Item("TotAkhir") = Me.GridView2.GetFocusedDataRow.Item("SisaBayar") Then
            ...
            Me.TBCustomer.Text = Me.GridView2.GetFocusedDataRow.Item("Nama")
    ...
    Private Sub BSave_Click(sender As Object, e As EventArgs) Handles BSave.Click
        ...
        Dim command As New SqlCommand("Select CodeID From M_DocCode Where DocID=54", koneksi)
        ...
        Select Case Indicator
            Case 100
                Dim cmSP As New SqlCommand("SPInsT_JualBebas_SJ")
                cmSP.CommandType = CommandType.StoredProcedure
                Dim x As Integer
                If XtraMessageBox.Show("Apakah Anda Mau Menyimpan Data  Ini ?", "Konfirmasi", MessageBoxButtons.YesNo, MessageBoxIcon.Question) = Windows.Forms.DialogResult.Yes Then
                    ...
                    With cmSP
                        ...
                        .Parameters.Add("@CustID", SqlDbType.VarChar).Value = Me.TBCustomer.Text.ToString
                        ...
                        Try
                            ...
                            Dim i : For i = 0 To GridView1.RowCount - 1
                                If Not IsDBNull(Me.GridView1.GetRowCellValue(i, "Nama")) Then
                                    Dim cmSPDtl As New SqlCommand("SPInsT_JualBebas_SJDtl")
                                    ...
                                    With cmSPDtl
                                        ...
                                        .Parameters.Add("@Size", SqlDbType.VarChar).Value = Me.GridView1.GetRowCellValue(i, "Size")
                ...
                End If
            Case 200
                Dim cmSP As New SqlCommand("SPUpT_JualBebas_SJ")
                cmSP.CommandType = CommandType.StoredProcedure
                Dim x As Integer
                ...
                With cmSP
                    ...
                    Try
                        ...
                        If x = -1 Then
                            MsgBox(Me.TBCustomer.Text.ToString)
                            MsgBox("MASUK " & x)
                        ...
                        Dim y : For y = 0 To arrPar.GetUpperBound(0)
                            Dim cmSPDel As New SqlCommand("SPDelT_JualBebas_SJDtl")
                        ...
                        Dim i : For i = 0 To GridView1.RowCount - 1
                            ...
                            Else
                                If Not IsDBNull(Me.GridView1.GetRowCellValue(i, "Nama")) Then
                                    Dim cmSPDtl As New SqlCommand("SPUpT_JualBebas_SJDtl")
                                    cmSPDtl.CommandType = CommandType.StoredProcedure
        ...
        Dim cmd2 As New SqlCommand("SPAftSJualBebas_SJ")
    ...
    'Private Sub SLUCust_Leave(sender As Object, e As EventArgs)
    '    Try
    ...
    Private Sub GridView1_InitNewRow(ByVal sender As Object, ByVal e As DevExpress.XtraGrid.Views.Grid.InitNewRowEventArgs) Handles GridView1.InitNewRow
        Try
            ...
            Me.GridView1.SetRowCellValue(e.RowHandle, "Size", "")
